...
void test_linked_list() {
    ...
    char* next_first_elements = get_first(new_list);
    assert(!strcmp(next_first_elements, "test1"));

    char* last_element_test = get_last(new_list);
    assert(!(strcmp(last_element_test, "test2")));
